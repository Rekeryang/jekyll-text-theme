...
| --------------- | ----------- |
| **Mathjax** | Make it easy to add mathematics in articles, using MathML, LaTeX and ASCIIMathML markup | [EXAMPLES](https://rekeryang.com/jekyll-TeXt-theme/post/2017/07/07/mathjax.html) |
| **Mermaid** | Bring diagrams and flowcharts in articles | [EXAMPLES](https://rekeryang.com/jekyll-TeXt-theme/post/2017/06/06/mermaid.html) |
| **Chart**   | Bring charts in articles | [EXAMPLES](https://rekeryang.com/jekyll-TeXt-theme/post/2017/05/05/chart.html) |
