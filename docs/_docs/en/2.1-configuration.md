...
The base hostname and protocol for your site. if you are hosting the site on Github Pages this will be set as the GitHub Pages domain (cname or user domain)[^gitHub_metadata]. For example, https://kitian616.github.io or https://rekeryang.com if there is cname file.
...
The language of your site, you can override it with different ones on specific posts, pages by YAML Front Matter[^font_matter], learn more at [Internationalization](https://rekeryang.com/jekyll-text-theme/docs/en/i18n).
...
“NWO” stands for “name with owner.” It is GitHub lingo for the username of the owner of the repository plus a forward slash plus the name of the repository, e.g. rekeryang/jekyll-text-theme, where “kitian616” is the owner and “jekyll-text-theme” is the repository name.
...
This setting has been **MOVED** to the YAML Front Matter of Articles and home layout **Since Version 2.2.0**, You can find more information [HERE](https://rekeryang.com/jekyll-text-theme/docs/en/layouts#articles-layout).
{:.error}
...
You NEED set `sharing` variable as `true` in the page’s YAML Front Matter to enable sharing on this page, you can find more information [HERE](https://rekeryang.com/jekyll-text-theme/docs/en/layouts#article-layout).
{:.warning}
...
For all the above comments systems, you NEED set `key` variable in the page’s YAML Front Matter to enable comments on this page, you can find more information [HERE](https://rekeryang.com/jekyll-text-theme/docs/en/layouts#page-layout).
{:.warning}
...
The detail guide of LeanCloud will find in [Chinese document](https://rekeryang.com/jekyll-text-theme/docs/zh/configuration#leancloud) since LeanCloud haven't provide an English-language edition.
{:.info}
...
For all the above pageview statistics, you **NEED** set `key` variable in the page’s YAML Front Matter to enable statistics on this page, you can find more information [HERE](https://rekeryang.com/jekyll-text-theme/docs/en/layouts#page-layout).
{:.warning}
