...
<style>
  ...
  .hero-bg-image-example {
    background-image: url("https://rekeryang.com/jekyll-TeXt-theme/docs/assets/images/cover3.jpg");
  }
  .hero-bg-image-example--linear-gradient {
    background-image: linear-gradient(135deg, rgba(255, 69, 0, .5), rgba(255, 197, 0, .2)), url("https://rekeryang.com/jekyll-TeXt-theme/docs/assets/images/cover3.jpg");
  }
</style>
