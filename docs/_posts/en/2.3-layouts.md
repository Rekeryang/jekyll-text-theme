...
| **author**        | `!!map`               | Assign one of the authors in *authors.yml* to a post or page, see [Authors](https://rekeryang.com/jekyll-text-theme/docs/en/authors) for detail. | 2.2.0 |
...
| **type**          | item, brief, grid | TeXt supports 3 article list type with various settings, yan can find examples [HERE](https://rekeryang.com/jekyll-text-theme/samples.html#articles-layout). |
